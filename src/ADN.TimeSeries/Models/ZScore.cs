...
namespace ADN.TimeSeries
{
    ...
    /// </summary>
    public abstract class ZScore
    {
        protected List<double> _filteredY = new List<double>();
        protected List<double> _avgFilter = new List<double>();
        protected List<double> _stdFilter = new List<double>();

        protected double _threshold = 0;
        protected double _influence = 0;
        protected int _lag = 10;
        ...
        public int Add(double value)
        {
            ...
            if (i > _lag)
            {
                ...
                //Adjust the filters
                _avgFilter.Add(ComputeAverage(_filteredY, i - _lag, i));
            ...
            else
            {
                ...
                //Adjust the filters
                _avgFilter.Add(ComputeAverage(_filteredY, 0, i));
        ...
        protected abstract double ComputeAverage(List<double> values, int start, int end);
    }
}
